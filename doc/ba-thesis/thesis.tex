...
\begin{abstract}
	...
	% TIMM: Nicht nur an dieser Stelle sondern allgemein: es wäre gut hierfür einen Beleg oder Referenz zu "benefits object detection systems" zu haben. Ansonsten würde ich die Aussage etwas abschwächen: “reduce the domain gap between RGB and IR and thus potentially improve object detection systems” o.ä.
\end{abstract}
