...
\Citeauthor*{sbgm} already suggested colorization methods using diffusion models \parencite{sbgm}.
...
% TODO Explanation why this approximation works: Night, only one light source, not to strong, so trees are not visible ...
...
% TODO resolve conflict to statement: "unconditional sampling is always the best" 
