...
DATASET_OUT_DIR = os.getenv("DATASET_OUT") if os.getenv("DATASET_OUT") is not None else join(DATA_DIRECTORY, "out")

CALTECH_NIR_DATASET_OUT = join(DATASET_OUT_DIR, "caltech")
CALTECH_NIR_DATASET_SPECIFICATION = join(DATA_DIRECTORY, "nir_dataset_spec.json")

CALTECH_NIR_INCANDESCENT_DATASET_OUT = join(DATASET_OUT_DIR, "caltech-incandescent")
CALTECH_NIR_INCANDESCENT_DATASET_SPECIFICATION = join(DATA_DIRECTORY, "nir_incandescent_dataset_spec.json")

CALTECH_GRAY_DATASET_OUT = join(DATASET_OUT_DIR, "caltech-gray")
CALTECH_GRAY_DATASET_SPECIFICATION = join(DATA_DIRECTORY, "gray_dataset_spec.json")

SERENGETI_NIR_INCANDESCENT_DATASET_OUT = join(DATASET_OUT_DIR, "serengeti-incandescent")
SERENGETI_NIR_INCANDESCENT_DATASET_SPECIFICATION = join(DATA_DIRECTORY, "serengeti_incandescent_dataset_spec.json")

SERENGETI_NIR_INCANDESCENT_LARGE_DATASET_OUT = join(DATASET_OUT_DIR, "serengeti-incandescent-large")
SERENGETI_NIR_INCANDESCENT_LARGE_DATASET_SPECIFICATION = join(DATA_DIRECTORY,
                                                              "serengeti_incandescent_large_dataset_spec.json")

SERENGETI_NIR_INCANDESCENT_SPLIT_DATASET_OUT = join(DATASET_OUT_DIR, "serengeti")
